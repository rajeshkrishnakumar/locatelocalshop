...
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
$route['contact-us']='welcome/contactusview';
$route['contactus/contactuspost']='welcome/contactuspost';
$route['privacy']='welcome/privacyview';
$route['terms']='welcome/termsview';
$route['faqs']='welcome/faqsview';
$route['about-us']='welcome/aboutview';
...
$route['backend/contactus']='admin/adminconfig/contactusfetch';
$route['backend/contactus/complete/(:any)']='admin/adminconfig/completecontactus/$1';
