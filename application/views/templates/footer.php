	...
	<div class="footer-top">
		<div class="container-fluid">
			...
			<div class="col-xs-4 w3l-rightmk">
				<img src="<?php echo asset_url('images/tab3.png');?>" alt=" ">
			</div>
...
<footer>
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						...
						<a href="#">
							<img src="<?php echo asset_url('images/1.png');?>" alt="">
						</a>
						<a href="#">
							<img src="<?php echo asset_url('images/2.png');?>" alt="">
						</a>
						<div class="clearfix"> </div>
					</div>
				</div>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="<?php echo asset_url('images/pay2.png');?>" alt="">
						</li>
						<li>
							<img src="<?php echo asset_url('images/pay5.png');?>" alt="">
						</li>
						<li>
							<img src="<?php echo asset_url('images/pay1.png');?>" alt="">
						</li>
						<li>
							<img src="<?php echo asset_url('images/pay4.png');?>" alt="">
						</li>
						<li>
							<img src="<?php echo asset_url('images/pay6.png');?>" alt="">
						</li>
						<li>
							<img src="<?php echo asset_url('images/pay3.png');?>" alt="">
						</li>
						<li>
							<img src="<?php echo asset_url('images/pay7.png');?>" alt="">
						</li>
						<li>
							<img src="<?php echo asset_url('images/pay8.png');?>" alt="">
						</li>
						<li>
							<img src="<?php echo asset_url('images/pay9.png');?>" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<script src="<?php echo asset_url('js/jquery.flexisel.js');?>"></script>
	<script>
		$(window).load(function () {
	...
	<!-- credit-card -->
	<script src="<?php echo asset_url('js/creditly.js');?>"></script>
	<link rel="stylesheet" href="<?php echo asset_url('css/creditly.css');?>" type="text/css" media="all" />
