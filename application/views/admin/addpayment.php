                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Payment Method</h4>
                            </div>
                            <div class="card-body">
                                <form method="post" name='addpayment' id='addpayment'>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name='method_name' id="method_name" class="form-control" placeholder="Payment Method">
                                                     </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  id="payment_method_info" name='payment_method_info' class="form-control" placeholder="Payment Method Info">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
