            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Shipment Method</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Shipment Method</h4>
                            </div>
                            <div class="card-body">
                                <form method="post" name='addshipment' id='addshipment'>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name='method_name' id="method_name" class="form-control" placeholder="Shipment Method">
                                                     </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  id="shipment_method_info" name='shipment_method_info' class="form-control" placeholder="Shipment Method Info">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
