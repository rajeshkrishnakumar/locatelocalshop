<div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Product Assignment</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Edit product assignment</h4>
                            </div> 
                            <div class="card-body">
                                <form method="post" name='editproductassignment' id='editproductassignment'>
        ...
        <script type="text/javascript">
            ...
            jQuery('#product_id').val('<?php echo $editproduct['product_id']; ?>');
            jQuery('#vendor_id').val('<?php echo $editproduct['vendor_id']; ?>');
